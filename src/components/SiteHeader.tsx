    ...
    <>
      ...
      <header className="sticky top-0 z-50 border-b border-border/40 bg-background/90 backdrop-blur-xl">
        <div className="mx-auto max-w-7xl px-6 lg:px-10 flex h-16 items-center justify-between gap-8">
          ...
          {/* Desktop (≥768px) : ouvre le modal défini dans __root.tsx */}
          <label
      ...
      <label htmlFor="mobile-menu-toggle" className="mobile-overlay fixed inset-0 z-40 bg-black/50 lg:hidden cursor-pointer" style={{ display: "none" }} />
      ...
      <div className="mobile-panel fixed top-0 right-0 z-50 h-full w-72 max-w-full bg-background shadow-2xl lg:hidden flex flex-col">
        ...
        <div className="px-6 py-6 border-t border-border shrink-0">
          <a href="tel:+33978802232" className="flex items-center justify-center gap-2 w-full rounded-full bg-primary px-5 py-3 text-sm font-medium text-primary-foreground shadow-red hover:opacity-90 transition-all">
            <Phone className="h-4 w-4" /> 09 78 80 22 32
          </a>
        </div>
      </div>
