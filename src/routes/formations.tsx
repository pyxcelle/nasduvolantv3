...
const ContactButton = lazy(() =>
  import("@/components/ContactButton").then((m) => ({ default: m.ContactButton }))
);
...
const btnClass = "inline-flex items-center gap-2 rounded-full bg-primary px-7 py-4 text-sm font-medium text-primary-foreground shadow-red hover:opacity-90 transition-all";
    ...
    <>
      <section className="relative py-28 lg:py-40 bg-gradient-hero overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          ...
          <div className="mt-8">
            <Suspense fallback={<a href="tel:+33978802232" className={btnClass}>Nous appeler <ArrowRight className="h-4 w-4" /></a>}>
              <ContactButton className={btnClass} />
            </Suspense>
          </div>
        </div>
      </section>
